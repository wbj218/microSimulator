...
def main():
	...
	stage = march.make_stage(stage_name = "media", pathId = 0, pathStageId = 0, stageId = 0, blocking = False, batching = False, socket = False, 
	...
	# memcached
	media = march.make_micro_service(servType = "micro_service", servName = "media", bindConn = True, paths = [path], 
		baseFreq = 2600, curFreq = 2600)

	with open("./json/microservice/media.json", "w+") as f:
