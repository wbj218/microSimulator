...
def main():
	...
	stage = march.make_stage(stage_name = "post_storage", pathId = 0, pathStageId = 0, stageId = 0, blocking = False, batching = False, socket = False, 
	...
	# memcached
	post_storage = march.make_micro_service(servType = "micro_service", servName = "post_storage", bindConn = True, paths = [path], 
