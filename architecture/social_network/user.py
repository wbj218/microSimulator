...
def main():
	...
	stage = march.make_stage(stage_name = "user", pathId = 0, pathStageId = 0, stageId = 0, blocking = False, batching = False, socket = False, 
	...
	# memcached
	user = march.make_micro_service(servType = "micro_service", servName = "user", bindConn = True, paths = [path], 
