...
def send_cmd():
	...
	with open(DEC_FILE, 'w+') as f:
		...
		#cmd = "frontend: %u; search: %u; geo: %u; rate: %u; profile: %u; cur_round: %d" %(APP_FREQ_VEC['frontend'], APP_FREQ_VEC['search'], APP_FREQ_VEC['geo'], APP_FREQ_VEC['rate'], APP_FREQ_VEC['profile'], CUR_ROUND)
		#cmd = "load_balancer: %u; leaf_service_0: %u; leaf_service_1: %u; leaf_service_2: %u; leaf_service_3: %u; leaf_service_4: %u; cur_round: %d" %(APP_FREQ_VEC['load_balancer'], APP_FREQ_VEC['leaf_service_0'], APP_FREQ_VEC['leaf_service_1'], APP_FREQ_VEC['leaf_service_2'], APP_FREQ_VEC['leaf_service_3'], APP_FREQ_VEC['leaf_service_4'], CUR_ROUND)
		CUR_ROUND += 1
		f.write(cmd)
